function bBoxes = CandidateBoxesByWindowEdges(Imag,step,fr_threshold,margin)
...
factors=[1,(4/5),(3/4),(3/5),(1/2),(1/4),(1/6),(1/9)];
...
for i=1:length(factors)
  ...
  CurbBoxes=slideWindowEdges(CurImg,WindowSize,step,fr_threshold,margin);
