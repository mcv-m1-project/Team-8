%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Script for evaluation in task 2 - Sliding Window
%Perform Precision and Recall from the validation dataset using simple
%sliding window
...
% Perform Evaluation
[windowPrecision, windowSensitivity] = TrafficSignWindow_valid(valid_dir, ...
                     color_model, ...
                     backproj_thr, ...
